...
public class Contact implements Comparable<Contact>{
    ...
    Contact( String firstName, String lastName, int phoneNo[]){
        try {
            setAddress("unknown");
            setEmailA("unknown");
            File f = new File();
    ...
    Contact( String firstName, String lastName, String emailA){
        setAddress("unknown");
        File f = new File();
        setPicure(f);
        setFirstName(firstName);
    ...
    Contact( String firstName, String lastName, int phoneNo[], String emailA, File picture, String address){
        try {
            setAddress(address);
            if (!emailA.contains("@") || (!emailA.contains(".com") && !emailA.contains(".ro")))
                throw new InvalidDataException("Email address invalid");
