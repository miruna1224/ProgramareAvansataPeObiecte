...
public class Meeting extends Task {
    ...
    Meeting(int hour, int minute, boolean pm, int day, String month ){
        try {
            Vector<Contact> p = new Vector<>();
            setParticipants(p);
            setNoP(0);
    ...
    Meeting(int hour, int minute, boolean pm, int day, String month, int noP, Vector<Contact> participants){
        try {
