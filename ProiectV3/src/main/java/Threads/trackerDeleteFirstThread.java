...
public class trackerDeleteFirstThread extends Thread {
    public trackerDeleteFirstThread(String name) {
        super(name);
    }
        ...
        button.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent ae){
                ...
                if (!testField1.equals("") && !testField2.equals("") && !testField3.equals("")) {
                    CRUDTracker.deleteOneTracker(content, n1, n2);
                    new Audit("deleteFirst", trackerDeleteFirstThread.super.getName());
                }
            }
        });
