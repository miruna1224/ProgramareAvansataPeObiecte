...
import main.java.Exceptions.InexNoException;
...
public class Header {
    ...
    public Header( int day, String month, int year){
        try {
            String s = "";
            Calendar calendar = Calendar.getInstance(TimeZone.getDefault());
    ...
    public Header( int day, String month){
        try {
            String s = "";
            Calendar calendar = Calendar.getInstance(TimeZone.getDefault());
            int tday = calendar.get(Calendar.DATE);
